<x-app-layout title="Home">
    <div class="p-6 mx-auto max-w-7xl lg:p-8">
        <div class="flex justify-center">
            <svg class="w-auto h-16 text-indigo-600 " viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="mt-16">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                ...
                <a href="https://tailwindcss.com/docs" target="_blank">
                    <x-card>
                        <x-card.content>
                            ...
                            <x-card.description>
                                Tailwind CSS is a popular utility-first CSS framework that makes it easy to style
                                pages
                                by applying pre-defined classes to HTML elements.
                            </x-card.description>
                        </x-card.content>
                ...
                <a href="https://alpinejs.dev/docs" target="_blank">
                    <x-card>
                        <x-card.content>
                            <x-avatar
                                class="flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-900/20">
                                <svg class="text-indigo-400 fill-current w-7 h-7" viewBox="0 0 55 25" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="m42.753 0 12.112 12.06-12.112 12.058L30.641 12.06 42.753 0Z"
                                        fill="currentColor" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="m12.473 0 25.11 25H13.358L.36 12.06 12.473 0Z" fill="currentColor" />
                                </svg>
                            </x-avatar>
                            <x-card.title>
                                AlpineJs
                            ...
                            <x-card.description>
                                AlpineJS is a lightweight JavaScript framework that allows you to add interactivity to
                                your HTML using simple declarative syntax.
                            </x-card.description>
                        </x-card.content>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            class="self-center w-6 h-6 mx-6 shrink-0 stroke-indigo-500">
                ...
                <a href="https://laravel.com/docs" target="_blank">
                    <x-card>
                        <x-card.content>
                            <x-avatar
                                class="flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-900/20">
                                <svg class="text-indigo-400 translate-x-px translate-y-px fill-current w-7 h-7"
                            ...
                            <x-card.description>
                                Laravel is a free and open-source PHP web framework that allows developers to build web
                ...
                <a href="https://livewire.laravel.com/docs" target="_blank">
                    <x-card>
                        <x-card.content>
                            <x-avatar
                                ...
                                <svg class="text-indigo-400 translate-x-px translate-y-px fill-current w-7 h-7"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="currentColor" />
                                    <mask id="a-livewire" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="6"
                                        y="23" width="27" height="22">
                                        <path
                                    ...
                                    <mask id="b-livewire" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="6"
                                        y="19" width="27" height="14">
                                        <path
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path
                                        d="M15.89 13.44c.99 0 1.792-.818 1.792-1.827 0-1.008-.802-1.826-1.792-1.826s-1.793.818-1.793 1.826c0 1.009.803 1.827 1.793 1.827Z"
                                        fill="white" />
                                </svg>
                            </x-avatar>
                            <x-card.title>
                            ...
                            <x-card.description>
                                Livewire is a tool that simplifies the process of creating interactive and dynamic user
                                interfaces using PHP and Laravel.
                            </x-card.description>
                        </x-card.content>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" class="self-center w-6 h-6 mx-6 shrink-0 stroke-indigo-500">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
                        </svg>
                    </x-card>
